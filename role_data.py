...
ROLE_ABILITY_TEXTS = {
    ...
    Role.VIGILANTE: (
        ...
        ("숙청 처형 [1회용]", "밤에 한 명을 선택해 처형을 시도합니다. 대상이 마피아팀이면 처형하고, 아니어도 기회는 소진됩니다."),
    ),
    Role.DOCTOR: (
...
ROLE_RULE_TEXTS = {
    ...
    Role.VIGILANTE: (
        ...
        "밤 처형은 조사와 별개의 1회용 능력입니다. 조사하지 않은 대상도 선택할 수 있습니다.",
        "처형 대상이 마피아팀이면 사망하고, 마피아팀이 아니거나 이미 사망했다면 실패하지만 기회는 소진됩니다.",
    ),
    Role.DOCTOR: (
