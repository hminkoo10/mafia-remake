...
- **관리 로그 채널**(`/마피아로그채널`)에는 관리자 작업 말고도 코인이 오가는 일이 5초마다 모여 종류별로 올라갑니다: 주식 로그(체결·지정가 주문·취소·만료, 청약·배정, 회사 설립·상장·배당·유상증자·자사주·위험도·해산, 배당·청산 지급, 분기 실적, 관리종목·파산·상장폐지), 카지노 로그(바이인·캐시아웃), 코인 로그(출석·구조금).
