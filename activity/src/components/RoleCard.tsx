...
const ROLE_DESCRIPTIONS: Record<string, string> = {
  ...
  심리학자: "낮에 한 명을 관찰합니다.",
  도둑: "지목 투표에서 선택한 대상의 역할 능력을 훔칩니다.",
  ...
  광신도: "교주의 명령을 따릅니다.",
  마담: "지목 투표에서 선택한 대상을 유혹합니다. 별도 유혹 행동은 없습니다.",
  마녀: "플레이어를 개구리로 만들어 밤 능력과 모든 게임 채팅 발언을 막습니다.",
  과학자: "죽은 플레이어를 소생시킵니다.",
  청부업자: "특수 계약으로 승리를 노립니다.",
  조커: "처형당하면 승리합니다.",
  성직자: "저주를 정화합니다.",
  개구리: "밤 능력을 사용할 수 없고 저주가 풀릴 때까지 게임 채팅에서 발언할 수 없습니다.",
  고양이: "특수 능력을 가집니다.",
};
