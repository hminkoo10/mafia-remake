...
const WEB_ROLE_GUIDES: &[WebRoleGuide] = &[
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "소생",
        summary: "첫 사망 전에는 모든 팀 판정에서 시민팀으로 취급됩니다. 처음 사망하면 마피아팀으로 전환되고 다음 밤에 부활하며, 이후에는 마피아 비밀방과 마피아팀 승리 조건에 포함됩니다. 죽음이 곧 끝이 아니므로 사망 전 시민팀 운영과 부활 후 마피아팀 운영이 완전히 달라집니다.",
        tips: &[
            "첫 사망 전에는 시민팀 승리와 시민팀 판정에 포함된다는 점을 활용하세요.",
            "소생 타이밍 뒤 마피아 수 계산을 다시 하세요.",
            "죽은 상태에서도 공개 정보가 어떻게 쌓이는지 보세요.",
            "소생 후 바로 표적이 될 수 있어 후속 발언을 준비하세요.",
        ],
        caution: "첫 사망 전에는 마피아팀으로 판정되지 않으며 마피아 비밀방에도 참여하지 않습니다. 사망 후에는 시민팀이 아닌 마피아팀입니다.",
    },
    WebRoleGuide {
        role: Role::Madam,
        team: "마피아팀",
...
fn role_rating_hint(role: Role) -> &'static str {
    match role {
        ...
        Role::Scientist => "첫 사망 전 시민팀 기여와 부활 후 마피아팀 생존 변수 창출을 평가합니다.",
