...
const WEB_ROLE_GUIDES: &[WebRoleGuide] = &[
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "경찰계열",
        summary: "게임 중 한 번만 밤에 한 명을 수사합니다. 결과는 대상을 제출하는 즉시 나오고, 대상은 다시 바꿀 수 없습니다. 대상이 형사와 같은 팀이면 직업을 알게 되고, 수사를 받은 대상에게는 밤이 끝날 때 형사의 정체가 전달됩니다. 다른 팀을 수사하면 직업을 알 수 없지만 1회용 수사는 그대로 소모됩니다.",
        tips: &[
