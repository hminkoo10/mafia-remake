...
const WEB_ROLE_GUIDES: &[WebRoleGuide] = &[
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "수사",
        summary: "밤마다 한 명을 조사해 마피아 판정 여부를 확인합니다. 대상을 제출하는 즉시 결과가 나오고, 그 밤에는 대상을 다시 바꿀 수 없습니다. 결과는 그때 한 번만 전달되고 아침에 다시 오지 않으며, 제출 시점의 판정이 그대로 확정됩니다(밤 사이 대상이 접선해도 바뀌지 않음). 결과는 강력하지만 대부의 조사 회피, 보조직의 접선 상태 같은 예외가 있어 결과 해석이 중요합니다.",
        tips: &[
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "추적",
        summary: "실시간 추적입니다. 대상을 고른 순간 그 사람이 지금 누구에게 능력을 쓰고 있는지 바로 보이고, 밤 동안 대상이 손을 바꾸면 즉시 알림이 옵니다. 마피아 본대를 추적하면 그 사람 개인의 손이 아니라 마피아팀이 과반으로 정한 처형 대상이 보이고, 과반이 없으면 아무도 고르지 않은 것으로 보입니다. 추적 대상은 밤마다 한 번만 고를 수 있고 제출 후에는 바꿀 수 없습니다. 밤이 끝날 때 따로 결과가 오지는 않습니다.",
        tips: &[
            "밤 초반에 빨리 붙을수록 손 변경까지 전부 지켜볼 수 있습니다.",
            "밤 행동이 있는 직업 주장자 위주로 추적 가치가 높습니다.",
            "손을 자주 바꾸는 움직임 자체가 강력한 단서입니다.",
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "방어",
        summary: "마피아 공격을 한 번 버틸 수 있는 시민팀 방어 역할입니다. [불침번] 자신을 노린 스파이의 첩보, 도둑의 도벽, 사기꾼의 사기, 청부업자의 청부를 무효화하고 그 사용자의 정체를 개인 DM으로 알아냅니다. 방탄 발동은 강한 생존 정보가 되며 마피아의 공격 의도도 추론할 수 있습니다. 마녀의 저주(개구리) 상태에서는 방탄과 불침번이 모두 멈춥니다.",
        tips: &[
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "투표 견제",
        summary: "밤에 한 명을 공갈해 다음 낮 지목 투표권을 막습니다. 공갈은 제출 즉시 발동해 대상은 그 자리에서 공갈당한 사실을 알게 되고, 건달은 그 밤에 대상을 바꿀 수 없습니다. 투표권 하나가 승패를 바꾸는 후반에 특히 강합니다.",
        tips: &[
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "누적 정보",
        summary: "밤에 최면 대상을 누적하고 낮에 한 번에 깨워 팀 또는 직업 정보를 확인합니다. 깨우면 다음 밤에는 최면을 쓸 수 없어 정보 공개 타이밍이 핵심입니다. 최면을 건 대상이 그 밤에 죽어도 최면은 남아 다음 낮에 깨워 확인할 수 있습니다.",
        tips: &[
    ...
    WebRoleGuide {
        ...
        team: "마피아팀",
        kind: "첩보/접선",
        summary: "밤마다 플레이어 한 명을 선택해 직업을 알아냅니다. 첩보 결과는 제출 즉시 한 번만 전달됩니다. 첩보로 마피아를 찾아내면 그 밤 첩보를 한 번 더 사용할 수 있고, 처음 마피아를 찾은 시점에 마피아팀과 접선합니다.",
        tips: &[
    ...
    WebRoleGuide {
        ...
        team: "마피아팀",
        kind: "저주",
        summary: "밤에 대상을 개구리로 저주해 다음 밤까지 그 직업의 능력과 모든 게임 채팅 발언을 막습니다. 밤·낮 능력은 물론 군인의 방탄·불침번, 정치인의 2표와 처형 면역, 연인의 희생, 심판의 결정 같은 상시 능력도 저주 동안 멈춥니다. 사망 시 발동하는 능력(테러리스트 반격, 과학자 부활)은 [망각술]이 있어야 막힙니다. 중요한 수사직이나 투표 영향력이 큰 사람을 흔드는 데 좋습니다.",
        tips: &[
...
const WEB_CONFIG_FIELDS: &[WebConfigField] = &[
    ...
    field(
        "reward_game_coins",
        "마피아 참여 보상(원, 판을 끝까지 하면 받음, 0이면 끔)",
        WebFieldKind::Int,
        Some(0),
    ),
    field(
