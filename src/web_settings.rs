...
const WEB_ROLE_GUIDES: &[WebRoleGuide] = &[
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "추적",
        summary: "실시간 추적입니다. 대상을 고른 순간 그 사람이 지금 누구에게 능력을 쓰고 있는지 바로 보이고, 밤 동안 대상이 손을 바꾸면 즉시 알림이 옵니다. 추적 대상은 밤마다 한 번만 고를 수 있고 제출 후에는 바꿀 수 없습니다. 밤이 끝날 때 따로 결과가 오지는 않습니다.",
        tips: &[
