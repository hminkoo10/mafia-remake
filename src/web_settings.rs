...
const WEB_ROLE_GUIDES: &[WebRoleGuide] = &[
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "경찰계열",
        summary: "게임 중 한 번만 밤에 한 명을 수사합니다. 대상이 형사와 같은 팀이면 밤이 끝날 때 형사는 대상의 직업을 알게 되고, 수사를 받은 대상에게는 형사의 정체가 전달됩니다. 다른 팀을 수사하면 직업을 알 수 없고 대상에게도 수사 사실이 전달되지 않지만, 1회용 수사는 그대로 소모됩니다.",
        tips: &[
        ...
        caution: "수사는 게임 중 1회뿐이고 다른 팀을 수사해도 소모됩니다. 같은 팀을 수사하면 대상에게 형사의 정체가 전달되므로 공개 타이밍도 계산해야 합니다.",
    },
    WebRoleGuide {
        role: Role::Detective,
        team: "시민팀",
    ...
    WebRoleGuide {
        ...
        team: "시민팀",
        kind: "정보 수집",
        summary: "밤마다 직업 하나를 지목해 조회합니다. 경찰 계열과 시민 직업은 조회할 수 없습니다. 밤이 끝날 때 그 직업을 가진 생존자가 누구인지 정확히 알게 되고, 그 직업이 이번 게임에 없거나 보유자가 없으면 없다는 결과만 받습니다. 없는 직업을 골라도 그날 밤 조회는 소모되며, 같은 밤에 다시 시도할 수 없습니다.",
        tips: &[
