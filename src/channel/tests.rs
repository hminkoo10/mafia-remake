...
fn selection_test_config() -> config::BotConfig {
    config::BotConfig {
        ...
        reward_game_coins: crate::stats::DEFAULT_REWARD_GAME_COINS,
        reward_win_coins: crate::stats::DEFAULT_REWARD_WIN_COINS,
        reward_daily_games: crate::stats::DEFAULT_REWARD_DAILY_GAMES,
        mission_coins: crate::stats::DEFAULT_MISSION_COINS,
        mission_bonus_coins: crate::stats::DEFAULT_MISSION_BONUS_COINS,
        achievement_reward_pct: crate::stats::DEFAULT_ACHIEVEMENT_REWARD_PCT,
        streak_week_coins: crate::stats::DEFAULT_STREAK_WEEK_COINS,
        streak_month_coins: crate::stats::DEFAULT_STREAK_MONTH_COINS,
