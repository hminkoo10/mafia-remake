...
pub(crate) fn render_tiers_page() -> String {
    let mut body = String::from(
        r#"<section class="panel"><h2>개인 티어 시스템</h2><p class="meta">게임마다 모든 플레이어가 티어를 비공개로 배정받습니다. 내 티어와 능력은 게임 시작 시 역할 DM에서 확인할 수 있고, 게임 결과에서 전원의 티어가 공개됩니다.</p><ul><li>확률: 2티어 40% / 3티어 30% / 4티어 15% / 5티어 10% / 6티어 5%</li><li>마피아 본대는 무조건 3티어 이상입니다 (2티어 몫을 비례 배분: 3티어 50% / 4티어 25% / 5티어 16.7% / 6티어 8.3%).</li><li>2티어는 능력이 없고, 3티어는 3티어 능력 1개를 받습니다.</li><li>4티어부터는 소속·역할에 맞는 풀에서 4티어 이상 능력을 받습니다 — 4티어 1개, 5티어 2개, 6티어 3개 (서로 다른 능력).</li><li>4티어 이상 풀이 개수보다 작으면(예: 시민팀 풀은 유언·확성 2개) 나머지는 3티어 능력(가호·묵비권)으로 채웁니다.</li><li>같은 능력이 여러 플레이어에게 겹쳐서 배정될 수 있습니다.</li></ul></section>"#,
    );
